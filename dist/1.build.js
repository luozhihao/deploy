...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "D:\\work\\Aptana Studio 3 Workspace\\deploy\\static\\src\\components\\deploy_manage\\run_board\\RunBoard.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js?sourceMap!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-11611f29&file=RunBoard.vue&scoped=true!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./RunBoard.vue", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js?sourceMap!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-11611f29&file=RunBoard.vue&scoped=true!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./RunBoard.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "D:\\work\\Aptana Studio 3 Workspace\\deploy\\static\\src\\components\\deploy_manage\\run_board\\Add.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js?sourceMap!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-3a07a203&file=Add.vue&scoped=true!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Add.vue", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js?sourceMap!./../../../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-3a07a203&file=Add.vue&scoped=true!./../../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./Add.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vueStrap = __webpack_require__(78);
	...
	//                     <div class="col-sm-8">
	//                         <v-select :value.sync="version" :options="versions" placeholder="请选择">
	//                         </v-select>
	//                     </div>
	//                 </div>
	//                 <div class="form-group">
	//                     <label class="control-label col-sm-3">版本/型号：</label>
	//                     <div class="col-sm-8">
	//                         <input type="text" class="form-control">
	//                     </div>
	//                 </div>
...
/***/ function(module, exports) {
	...
	module.exports = "\n    <modal :show.sync=\"addModal\" effect=\"fade\" width=\"450px\" _v-3a07a203=\"\">\n        <div slot=\"modal-header\" class=\"modal-header\" _v-3a07a203=\"\">\n            <h4 class=\"modal-title\" _v-3a07a203=\"\">添加</h4>\n        </div>\n        <div slot=\"modal-body\" class=\"modal-body\" _v-3a07a203=\"\">\n            <form class=\"form-horizontal\" _v-3a07a203=\"\">\n                <div class=\"form-group\" _v-3a07a203=\"\">\n                    <label class=\"control-label col-sm-3\" _v-3a07a203=\"\">名称：</label>\n                    <div class=\"col-sm-8\" _v-3a07a203=\"\">\n                        <input type=\"text\" class=\"form-control\" _v-3a07a203=\"\">\n                    </div>\n                </div>\n                <div class=\"form-group input-box\" _v-3a07a203=\"\">\n                    <label class=\"control-label col-sm-3\" _v-3a07a203=\"\">类型：</label>\n                    <div class=\"col-sm-8\" _v-3a07a203=\"\">\n                        <v-select :value.sync=\"version\" :options=\"versions\" placeholder=\"请选择\" _v-3a07a203=\"\">\n                        </v-select>\n                    </div>\n                </div>\n                <div class=\"form-group\" _v-3a07a203=\"\">\n                    <label class=\"control-label col-sm-3\" _v-3a07a203=\"\">版本/型号：</label>\n                    <div class=\"col-sm-8\" _v-3a07a203=\"\">\n                        <input type=\"text\" class=\"form-control\" _v-3a07a203=\"\">\n                    </div>\n                </div>\n                <div class=\"form-group\" _v-3a07a203=\"\">\n                    <label class=\"control-label col-sm-3\" _v-3a07a203=\"\">备注：</label>\n                    <div class=\"col-sm-8\" _v-3a07a203=\"\">\n                        <textarea class=\"form-control\" rows=\"5\" _v-3a07a203=\"\"></textarea>\n                    </div>\n                </div>\n            </form>\n        </div>\n        <div slot=\"modal-footer\" class=\"modal-footer\" _v-3a07a203=\"\">\n            <button type=\"button\" class=\"btn btn-default\" _v-3a07a203=\"\">保存</button>\n            <button type=\"button\" class=\"btn btn-default\" @click=\"addModal = false\" _v-3a07a203=\"\">取消</button>\n        </div>\n    </modal>\n";

/***/ },
/* 80 */
/***/ function(module, exports) {

	module.exports = "\n    <div _v-11611f29=\"\">\n        <form class=\"form-inline\" _v-11611f29=\"\">\n            <div class=\"form-group\" _v-11611f29=\"\">\n                <label _v-11611f29=\"\">名称：</label>\n                <input type=\"text\" class=\"form-control\" v-model=\"name\" _v-11611f29=\"\">\n            </div>\n            <div class=\"form-group\" _v-11611f29=\"\">\n                <label _v-11611f29=\"\">类型：</label>\n                <v-select :value.sync=\"type\" :options=\"types\" placeholder=\"请选择\" _v-11611f29=\"\">\n                </v-select>\n            </div>\n            <div class=\"mt30 table-btn\" _v-11611f29=\"\">\n                <button type=\"button\" class=\"btn btn-default btn-pd\" @click=\"$broadcast('showModal')\" _v-11611f29=\"\">\n                    <span class=\"glyphicon glyphicon-plus\" _v-11611f29=\"\"></span>\n                    添加\n                </button>\n            </div>\n            <table class=\"table table-hover table-bordered table-bg\" _v-11611f29=\"\">\n                <thead _v-11611f29=\"\">\n                    <tr _v-11611f29=\"\">\n                        <th _v-11611f29=\"\">名称</th>\n                        <th _v-11611f29=\"\">类型</th>\n                        <th _v-11611f29=\"\">版本/型号</th>\n                        <th _v-11611f29=\"\">检查规则</th>\n                        <th _v-11611f29=\"\">备注</th>\n                        <th _v-11611f29=\"\">操作</th>\n                    </tr>\n                </thead>\n                <tbody _v-11611f29=\"\">\n                    <tr _v-11611f29=\"\">\n                        <td _v-11611f29=\"\">linux</td>\n                        <td _v-11611f29=\"\">操作系统</td>\n                        <td _v-11611f29=\"\">2.6.32-431.el6.x86_64</td>\n                        <td _v-11611f29=\"\">\n                            <button type=\"button\" class=\"btn btn-default btn-small\" _v-11611f29=\"\">\n                                <span class=\"table-icon glyphicon glyphicon-pencil\" _v-11611f29=\"\"></span>\n                                编辑\n                            </button>\n                            <button type=\"button\" class=\"btn btn-default btn-small\" _v-11611f29=\"\">\n                                <span class=\"table-icon glyphicon glyphicon-eye-open\" _v-11611f29=\"\"></span>\n                                查看\n                            </button>\n                        </td>\n                        <td _v-11611f29=\"\">centeros 5+</td>\n                        <td _v-11611f29=\"\">\n                            <button type=\"button\" class=\"btn btn-default btn-small\" _v-11611f29=\"\">\n                                <span class=\"table-icon glyphicon glyphicon-edit\" _v-11611f29=\"\"></span>\n                                修改\n                            </button>\n                            <button type=\"button\" class=\"btn btn-default btn-small\" _v-11611f29=\"\">\n                                <span class=\"table-icon glyphicon glyphicon-trash\" _v-11611f29=\"\"></span>\n                                删除\n                            </button>\n                        </td>\n                    </tr>\n                    <tr _v-11611f29=\"\">\n                        <td _v-11611f29=\"\">linux</td>\n                        <td _v-11611f29=\"\">操作系统</td>\n                        <td _v-11611f29=\"\">2.6.32-431.el6.x86_64</td>\n                        <td _v-11611f29=\"\">\n                            <button type=\"button\" class=\"btn btn-default btn-small\" _v-11611f29=\"\">\n                                <span class=\"table-icon glyphicon glyphicon-pencil\" _v-11611f29=\"\"></span>\n                                编辑\n                            </button>\n                            <button type=\"button\" class=\"btn btn-default btn-small\" _v-11611f29=\"\">\n                                <span class=\"table-icon glyphicon glyphicon-eye-open\" _v-11611f29=\"\"></span>\n                                查看\n                            </button>\n                        </td>\n                        <td _v-11611f29=\"\">centeros 5+</td>\n                        <td _v-11611f29=\"\">\n                            <button type=\"button\" class=\"btn btn-default btn-small\" _v-11611f29=\"\">\n                                <span class=\"table-icon glyphicon glyphicon-edit\" _v-11611f29=\"\"></span>\n                                修改\n                            </button>\n                            <button type=\"button\" class=\"btn btn-default btn-small\" _v-11611f29=\"\">\n                                <span class=\"table-icon glyphicon glyphicon-trash\" _v-11611f29=\"\"></span>\n                                删除\n                            </button>\n                        </td>\n                    </tr>\n                </tbody>\n            </table>\n        </form>\n        <add-modal _v-11611f29=\"\"></add-modal>\n    </div>\n";
