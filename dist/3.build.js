	    ...
	    events: {
	        'showModify': function showModify(param) {
	            ...
	            this.$http({
	                ...
	                _this3.modifyModal = true;
	
	                _this3.getIps();
	
	                _this3.inip = response.data.inip;
	                _this3.outip = response.data.outip;
